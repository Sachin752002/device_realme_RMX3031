...
{
    property_override_multiple("name", "Realme");
    property_override_multiple("model", "RMX3031");
    ...
    property_override("ro.build.fingerprint",
        "alps/vnd_oppo6893/oppo6893:11/RP1A.200720.011/mp2tc16sppr5V1:user/release-keys");
